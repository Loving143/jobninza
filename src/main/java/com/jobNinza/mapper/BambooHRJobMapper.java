...
@Component
public class BambooHRJobMapper extends BaseJobMapper {

    private static final String ATS_TYPE = "BambooHR";
    ...
    public List<Jobs> mapJobs(JsonNode root, Company company) {
        ...
        for (JsonNode jobNode : jobsNode) {
            ...
            // Workplace Type
            String workStatus = jobNode.path("workStatus").asText();
            mapWorkplaceType(workStatus, job);
            ...
            // Dates
            String datePosted = jobNode.path("datePosted").asText();
            job.setPostedAt(parseDate(datePosted));
